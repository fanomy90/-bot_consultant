...
#ветка открытие1
        ...
        answer = read_file(id_file='1iPxRfmJdziDJkMTqByi6xrS-6hTjmkFL')
    ...
    #Интегральный11
        ...
        answer = read_file(id_file='17IC85VWwls7XWtLbf6SYT-vPzZHc1Hta')
        bot.edit_message_text(answer, call.message.chat.id, call.message.message_id, reply_markup=keyboard_tovar)
        #Именной111
        ...
        answer = read_file(id_file='1c6TojXKPzkPKeVV88YXYgKemyv7LFtF4')
        bot.edit_message_text(answer, call.message.chat.id, call.message.message_id, reply_markup=keyboard_tovar)
        #Целевой1111
        ...
        answer = read_file(id_file='1YtCfI9848ar6dLXfvTekYJpWrAoBHBa-')
        bot.edit_message_text(answer, call.message.chat.id, call.message.message_id, reply_markup=keyboard_tovar)
        # Классовый1112
        ...
        keyboard_tovar.add(types.InlineKeyboardButton('В программе SunRise', callback_data='key11121'),
                           ...
                           types.InlineKeyboardButton('Назад', callback_data='key111'))
        answer = read_file(id_file='14LVQqfbmkqXa-HjrAkmyDOsW-wMt-ZBm')
        bot.edit_message_text(answer, call.message.chat.id, call.message.message_id, reply_markup=keyboard_tovar)
        #Совместный112
        ...
        keyboard_tovar.add(types.InlineKeyboardButton('Целевой (от 2283$)', callback_data='key1121'),
                           ...
                           types.InlineKeyboardButton('Назад', callback_data='key11'))
        answer = read_file(id_file='1jrS7SenmSJS6izAarQvNbs6NH8QgYKco')
        bot.edit_message_text(answer, call.message.chat.id, call.message.message_id, reply_markup=keyboard_tovar)
        #Кастодиальный113
        ...
        keyboard_tovar.add(types.InlineKeyboardButton('Целевой (от 2283$)', callback_data='key1131'),
                           ...
                           types.InlineKeyboardButton('Назад', callback_data='key11'))
        answer = read_file(id_file='1bFuFlHICypv9Be6W0k69851ooVxKEtZN')
        bot.edit_message_text(answer, call.message.chat.id, call.message.message_id, reply_markup=keyboard_tovar)
    #Присоединенный12
        ...
        keyboard_tovar.add(types.InlineKeyboardButton('Новый', callback_data='key121'),
                           ...
                           types.InlineKeyboardButton('Назад', callback_data='key1'))
        answer = read_file(id_file='1g2iYqW0uLo4vFHz4dcK5J60cPmiKlpsF')
        bot.edit_message_text(answer, call.message.chat.id, call.message.message_id, reply_markup=keyboard_tovar)
#ветка пополнение2
...
#ветка открытие
    #именного
        ...
        answer = read_file(id_file='10sglY1sWk44GUcKEoZiSj6i73Q4Pwz-I')
        bot.edit_message_text(answer, call.message.chat.id, call.message.message_id, reply_markup=keyboard_tovar)
        #В PDF редакторе
    elif call.data == 'key11112':
        keyboard_tovar = types.InlineKeyboardMarkup(row_width=1)
        keyboard_tovar.add(types.InlineKeyboardButton('Назад', callback_data='key1111'))
        answer = read_file(id_file='1KPfF8qOE8cpVW--GeGwSbXLAKpEOsN2V')
        bot.edit_message_text(answer, call.message.chat.id, call.message.message_id, reply_markup=keyboard_tovar)
        #классового1112
        ...
        answer = read_file(id_file='1t8geCgPqw0phCMR7UQxZh4RYKJ6jdSQg')
        bot.edit_message_text(answer, call.message.chat.id, call.message.message_id, reply_markup=keyboard_tovar)
        # В PDF редакторе11122
    elif call.data == 'key11122':
        keyboard_tovar = types.InlineKeyboardMarkup(row_width=1)
        keyboard_tovar.add(types.InlineKeyboardButton('Назад', callback_data='key1112'))
        answer = read_file(id_file='1GmeB2YBbI1ym9Hg5j6qobLr2GyCEPrT-')
        bot.edit_message_text(answer, call.message.chat.id, call.message.message_id, reply_markup=keyboard_tovar)
    ...
    #совместного
        ...
        answer = read_file(id_file='1egb91hHERpQOFc9SP0KUa-LTzxOhRt-R')
        bot.edit_message_text(answer, call.message.chat.id, call.message.message_id, reply_markup=keyboard_tovar)
        # классового
    elif call.data == 'key1122':
        keyboard_tovar = types.InlineKeyboardMarkup(row_width=1)
        keyboard_tovar.add(types.InlineKeyboardButton('Назад', callback_data='key112'))
        answer = read_file(id_file='1wxvUCudtmbX2bEpsUkz_U9OH1BAX4fn1')
        bot.edit_message_text(answer, call.message.chat.id, call.message.message_id, reply_markup=keyboard_tovar)
    #кастодиального
        # целевого
        ...
        answer = read_file(id_file='1UCoaFrvEU6AiKvAiHZRjZKUy1CmMy7J_')
        bot.edit_message_text(answer, call.message.chat.id, call.message.message_id, reply_markup=keyboard_tovar)
        # классового
    elif call.data == 'key1132':
        keyboard_tovar = types.InlineKeyboardMarkup(row_width=1)
        keyboard_tovar.add(types.InlineKeyboardButton('Назад', callback_data='key113'))
        answer = read_file(id_file='1sN9Cj_znpQ1DxOW-yZzwCvPlDyQ3tgS6')
        bot.edit_message_text(answer, call.message.chat.id, call.message.message_id, reply_markup=keyboard_tovar)
    #присоединенного
        #нового
        ...
        keyboard_tovar = types.InlineKeyboardMarkup(row_width=1)
        keyboard_tovar.add(types.InlineKeyboardButton('Назад', callback_data='key12'))
        answer = read_file(id_file='17e1F5wkfTf-_DT_T4wWqWdLRMDl4kg6F')
        bot.edit_message_text(answer, call.message.chat.id, call.message.message_id, reply_markup=keyboard_tovar)
    #Ветка пополнения
    #интегрального
        #взиморасчет
